...
trait Server
{
    ...
    /**
     * Delete if exists socket file
     *
     * @returtn void
     */
    public function deleteSocketFile()
    {
        $socketFile = $this->_socketFile;
        if (strpos($socketFile, "unix://") === 0) {
            $socketFile = str_replace("unix://", "", $socketFile);
        }
